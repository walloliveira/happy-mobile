...
const OrphanageData: React.FC = () => {
  ...
  const [opens_at_weekends, setOpensAtWeekends] = useState<boolean>(false);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TouchableOpacity style={styles.imagesInput} onPress={handlSelectImage}>
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          value={opens_at_weekends}
          onValueChange={setOpensAtWeekends}
        />
      </View>
